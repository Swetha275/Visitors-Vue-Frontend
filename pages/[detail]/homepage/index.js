    ...
    <Fragment>
      {userData.data == undefined ? (
        ...
        <>
          ...
          <HomeNav userData={userData.data.data.email} />
                ...
                <div className="row g-5 py-5">
                  <div className="col-lg-6 text-center text-lg-start">
                    ...
                    <p className="text-white pb-3 animated zoomIn">
                      Tired of maintaining visitor check-ins on books & paper?
                      Track and manage your daily visitors with ease on
                      Visitors-Vue
                    </p>
                  </div>
                  <div className="col-lg-6 text-center text-lg-start">
              ...
              <div className="row justify-content-center m-10 g-4">
                ...
                >
                  <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>
                      Add entry details of new visitors in your organization
                    </p>
                    <a
                ...
                >
                  <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>
                      check-out the visitors as they leave your organization
                    </p>
                    <a
                      className="btn px-3 mt-auto mx-auto"
                ...
                >
                  <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                    ...
                    <p>
                      Update the details of the employees as soon as they leave
                    </p>
                    <a
                      className="btn px-3 mt-auto mx-auto"
